"""
Django settings for tekon_website project.
...
SECRET_KEY = 'django-insecure-bke#my1eb20p^7+k6dpw5t*#o+$_23b@y1==krm3=txig^!qnm'
...
ROOT_URLCONF = 'tekon_website.urls'
...
DEFAULT_FROM_EMAIL = 'noreply@tekon-rl.cl'
